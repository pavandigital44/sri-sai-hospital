$(document).ready(function(){	
	...
	$(window).scroll(function(){
        ...
        $('#doctorModal').on('show.bs.modal', function(event) {
            ...
            var doctorImage = button.data('doctor-image');
            var doctorDesignation = button.data('doctor-designation');
            var doctorSpecialty = button.data('doctor-specialty');

            // Update modal content
            modal.find('#modalDoctorName').text(doctorName);
            modal.find('#modalDoctorImage').attr('src', doctorImage);
            modal.find('#modalSpecialty').text(doctorSpecialty);
            modal.find('#modalQualifications').html('<li>' + doctorDesignation.replace(/,\s*/g, '</li><li>') + '</li>');
        });
